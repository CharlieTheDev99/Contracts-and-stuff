...
contract SoulArena is Context, IERC20, Ownable {
    ...
    string private constant _name = "Soul Arena"; // 
    string private constant _symbol = "SA"; //
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 7;
    address public _marketingWallet = 0x4BFBE60Cd5B7D6A73f12dba42014CB744b0C5D4a;
